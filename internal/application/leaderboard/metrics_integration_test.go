...
func TestLeaderboardMetricsSnapshot(t *testing.T) {
	...
	if err != nil || len(b.Items) != 1 || b.Items[0].UserID == 0 {
		t.Fatal(b, err)
	}
	e := b.Items[0]
	if b.Decimals != 6 || e.TotalBet != "1000.000000" || e.TotalPayout == nil || *e.TotalPayout != "1985.000000" || e.NetWin == nil || *e.NetWin != "985.000000" || e.Available == nil || *e.Available != "1985.000000" {
		t.Fatal(b)
	}
