...
func (server *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /v1/admin/monitor/bets", server.protectRoles(server.adminCurrentBets, identity.RoleAdmin, identity.RoleOperator))
	mux.HandleFunc("GET /v1/admin/monitor/rounds", server.protectRoles(server.adminRoundCountdowns, identity.RoleAdmin, identity.RoleOperator))
	mux.HandleFunc("GET /v1/admin/bets", server.protectRoles(server.adminBets, identity.RoleAdmin, identity.RoleOperator))
	mux.HandleFunc("GET /v1/admin/ledger", server.protectRoles(server.adminLedger, identity.RoleAdmin, identity.RoleOperator))
	mux.HandleFunc("GET /v1/admin/refunds-clearances", server.protectRoles(server.adminRefundClearances, identity.RoleAdmin, identity.RoleOperator))
	...
	mux.HandleFunc("POST /v1/admin/lulu/send-code", server.protectRoles(server.secondPassword(server.luluSMSLogin(true)), identity.RoleAdmin, identity.RoleOperator))
	...
	mux.HandleFunc("GET /v1/admin/lulu/prime-time-configs", server.protectRoles(server.adminLuluPrimeTimeConfigs, identity.RoleAdmin, identity.RoleOperator))
	mux.HandleFunc("PUT /v1/admin/lulu/prime-time-config", server.protectRoles(server.secondPassword(server.updateLuluPrimeTimeConfig), identity.RoleAdmin, identity.RoleOperator))
	mux.HandleFunc("PUT /v1/admin/lulu/prime-time-configs", server.protectRoles(server.secondPassword(server.updateLuluPrimeTimeConfigs), identity.RoleAdmin, identity.RoleOperator))
