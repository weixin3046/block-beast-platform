...
func TestOpenAPIComponentTypesMatchGo(t *testing.T) {
	cases := []struct {
		...
		{"LuluPlayCurrencyConfig", operations.LuluPlayCurrencyConfig{}, false},
		{"LuluMenuPlay", operations.LuluMenuPlay{}, false},
		{"LuluMenuRoom", operations.LuluMenuRoom{}, false},
		{"LuluMenuGame", operations.LuluMenuGame{}, false},
		{"LuluMenus", operations.LuluMenus{}, false},
		{"LuluRoomPlayConfigUpdate", operations.LuluRoomPlayConfigUpdate{}, false},
		{"LuluRoomPlayConfigsUpdate", operations.LuluRoomPlayConfigsUpdate{}, false},
